...
class Config:
    """Base configuration."""
    SECRET_KEY = os.getenv('SECRET_KEY', 'loktantra-dev-secret-key-change-in-prod')
    ...
    # Firestore
    FIRESTORE_COLLECTION_LEADERBOARD = os.getenv('FIRESTORE_COLLECTION_LEADERBOARD', 'leaderboard')
    FIRESTORE_COLLECTION_PROGRESS = os.getenv('FIRESTORE_COLLECTION_PROGRESS', 'player_progress')
    ...
    ENABLE_VERTEX_AI = os.getenv('ENABLE_VERTEX_AI', 'false').lower() == 'true'
...
class ProductionConfig(Config):
    ...
    DEBUG = False
    TESTING = False
    # In production, auto-enable cloud services if project ID is set
